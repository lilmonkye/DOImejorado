...
@section('content')
    ...
    <div class="container" style="background-color: rgb(215, 228, 247)">
        ...
        <form action="{{ route('otro.contribuidorUpdate',['id' => $contribuidor->id]) }}" id="formulario" method="POST">
            @csrf
            ...
            <div>
                ...
                <div class="mb-3">
                    ...
                    <select class="form-select" name="rol" aria-label="Default select example">
                        <option value="{!! isset($contribuidor->rol)?$contribuidor->rol:old('rol') !!}"></option>
