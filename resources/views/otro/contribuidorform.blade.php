...
@section('content')
    ...
    <div class="container" style="background-color: rgb(215, 228, 247)">
        <h2 class="text-center p-3 text-secondary text-white " style="background-color: rgb(32, 66, 146)">Contribuidor</h2>
        ...
        <form action="#" id="formulario" method="POST">
            ...
            <div>
                <input type="hidden" name="idarticulo" value="" class="form-control">

                <div class="p-2">
                    <label for="apellido" class="form-lablel">+ Apellido</label>
                    <input type="text" value="{{ isset($contribuidor->apellido)?$contribuidor->apellido:old('apellido') }}" class="form-control" name="titulo">
                </div>

                <div class="p-2">
                    <label for="nombre" class="form-lablel">Nombre</label>
                    <input type="text" value="{{ isset($contribuidor->nombre)?$contribuidor->nombre:old('nombre') }}" class="form-control" name="titulo">
                </div>
