...
@section('content')
    <div class="container" style="background-color: rgb(215, 228, 247)">
        ...
        <form action="{{ route('otro.revistaUpdate',['id' => $revista->id]) }}" id="formulario" method="POST" >
            @csrf
            <div style="d-flex justify-content-around; justify-content:center; align-items:center" >
                ...
                <div class="mb-3 ">
                    ...
                    <input type="text" value="{!! isset($revista->tituloabr)?$revista->tituloabr:old('tituloabr') !!}" class="form-control" name="tituloabr">
                </div>
                ...
                <div class="mb-3">
                    ...
                    <select class="form-select" name="idioma" aria-label="Default select example">
                        <option value="{!! isset($revista->idioma)?$revista->idioma:old('idioma') !!}"></option>
