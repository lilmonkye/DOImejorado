        ...
        <div class="d-flex justify-content-around m-4">
            ...
            <div class="card" style="width: 20rem;">
                <div class="card-body">
                    ...
                    <p class="card-text">Aquí podras revisar las solicitudes pendientes y asignarlas a un revisor.</p>
                    <a href="{{ route('asignador.tsolicitudes') }}" class="btn btn-primary">Ver</a>
                </div>
            </div>
            {{-- <div class="card" style="width: 20rem;">
                <div class="card-body">
